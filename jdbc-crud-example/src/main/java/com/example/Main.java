...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n=== CREATE ===");
        Producto nuevoProducto = new Producto("Laptop HP", "Laptop HP Core i5 8GB RAM", 899.99, 10);
        int idGenerado = productoDAO.crear(nuevoProducto);
        System.out.println("Producto creado con ID: " + idGenerado);

        Producto otroProducto = new Producto("Monitor Dell", "Monitor Dell 27 pulgadas 4K", 349.99, 15);
